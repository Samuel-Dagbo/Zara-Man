        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
          ...
          <motion.div variants={stagger} initial="initial" animate="animate" className="bg-white rounded-2xl shadow-xl shadow-luxury-100/50 border border-luxury-100 p-8 sm:p-10">
            <motion.div variants={fadeUp} className="mb-8">
              <h1 className="text-3xl sm:text-4xl font-display font-bold text-espresso">Sign in</h1>
              <p className="text-luxury-500 mt-2 text-sm sm:text-base">Access your account to manage orders and more.</p>
            </motion.div>
                ...
                <div className="flex items-center justify-between pt-1">
                  <label className="flex items-center gap-2.5 cursor-pointer group">
                    <div className="relative">
                      ...
                      <div className="w-4 h-4 border border-luxury-300 rounded transition-colors peer-checked:bg-gold-500 peer-checked:border-gold-500 peer-focus:ring-2 peer-focus:ring-gold-500/20" />
                      <svg className="absolute inset-0 w-4 h-4 text-white opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
            ...
            <motion.div variants={fadeUp} className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center">
                  <span className="px-4 bg-white text-xs text-luxury-400 tracking-[0.1em] uppercase">or continue with</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full mt-5 h-12 border border-luxury-200 text-espresso text-sm font-medium rounded-xl
                           transition-all duration-200 flex items-center justify-center gap-3
                           hover:border-luxury-300 hover:bg-luxury-50 hover:shadow-sm active:scale-[0.98]"
              >
            ...
            <motion.p variants={fadeUp} className="text-center text-sm text-luxury-400 mt-8">
              ...
              <Link href="/auth/signup" className="text-espresso font-semibold hover:text-gold-600 transition-colors">
                Create one
              </Link>
            </motion.p>
          </motion.div>
